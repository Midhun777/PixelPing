...
export const COUNTRIES: CountryData[] = [
  ...
  { id: 'rus', iso2: 'ru', name: 'Russia', altNames: ['Russian Federation'], flag: '🇷🇺', capital: 'Moscow', continent: 'Europe', subregion: 'Eastern Europe', population: 143.4, areaSqKm: 17098246, famousCities: ['Moscow', 'Saint Petersburg', 'Kazan', 'Novosibirsk'], landmark: 'Red Square & Saint Basil\'s Cathedral', mountain: 'Ural Mountains', river: 'Volga' },
