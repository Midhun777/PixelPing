...
export const COUNTRIES: CountryData[] = [
  ...
  { id: 'alb', iso2: 'al', name: 'Albania', flag: '🇦🇱', capital: 'Tirana', continent: 'Europe', subregion: 'Southern Europe', population: 2.7, areaSqKm: 28748, famousCities: ['Tirana', 'Durrës', 'Sarandë'], landmark: 'Rozafa Castle' },
  ...
  { id: 'bih', iso2: 'ba', name: 'Bosnia and Herzegovina', flag: '🇧🇦', capital: 'Sarajevo', continent: 'Europe', subregion: 'Southern Europe', population: 3.2, areaSqKm: 51197, famousCities: ['Sarajevo', 'Mostar'], landmark: 'Stari Most (Mostar Bridge)' },
  ...
  { id: 'arm', iso2: 'am', name: 'Armenia', flag: '🇦🇲', capital: 'Yerevan', continent: 'Europe', subregion: 'Eastern Europe', population: 2.9, areaSqKm: 29743, famousCities: ['Yerevan', 'Gyumri'], landmark: 'Monastery of Khor Virap', mountain: 'Mount Ararat' },
  ...
  { id: 'lbn', iso2: 'lb', name: 'Lebanon', flag: '🇱🇧', capital: 'Beirut', continent: 'Asia', subregion: 'Middle East', population: 5.3, areaSqKm: 10452, famousCities: ['Beirut', 'Tripoli'], landmark: 'Baalbek Roman Ruins' },
  { id: 'irn', iso2: 'ir', name: 'Iran', flag: '🇮🇷', capital: 'Tehran', continent: 'Asia', subregion: 'Middle East', population: 88.5, areaSqKm: 1648195, famousCities: ['Tehran', 'Isfahan', 'Shiraz'], landmark: 'Persepolis Ancient City' },
  { id: 'irq', iso2: 'iq', name: 'Iraq', flag: '🇮🇶', capital: 'Baghdad', continent: 'Asia', subregion: 'Middle East', population: 44.5, areaSqKm: 438317, famousCities: ['Baghdad', 'Erbil', 'Basra'], landmark: 'Ziggurat of Ur', river: 'Tigris' },
  ...
  { id: 'mmr', iso2: 'mm', name: 'Myanmar', altNames: ['Burma'], flag: '🇲🇲', capital: 'Naypyidaw', continent: 'Asia', subregion: 'Southeast Asia', population: 54.2, areaSqKm: 676578, famousCities: ['Yangon', 'Mandalay', 'Naypyidaw'], landmark: 'Shwedagon Pagoda' },
  ...
  { id: 'uzb', iso2: 'uz', name: 'Uzbekistan', flag: '🇺🇿', capital: 'Tashkent', continent: 'Asia', subregion: 'Central Asia', population: 36.0, areaSqKm: 447400, famousCities: ['Tashkent', 'Samarkand', 'Bukhara'], landmark: 'Registan Square Samarkand' },
  { id: 'afg', iso2: 'af', name: 'Afghanistan', flag: '🇦🇫', capital: 'Kabul', continent: 'Asia', subregion: 'South Asia', population: 41.1, areaSqKm: 652230, famousCities: ['Kabul', 'Kandahar'], landmark: 'Minaret of Jam' },
  ...
  { id: 'bah', iso2: 'bs', name: 'Bahamas', flag: '🇧🇸', capital: 'Nassau', continent: 'North America', subregion: 'Caribbean', population: 0.41, areaSqKm: 13943, famousCities: ['Nassau', 'Freeport'], landmark: 'Atlantis Paradise Island' },
  ...
  { id: 'hnd', iso2: 'hn', name: 'Honduras', flag: '🇭🇳', capital: 'Tegucigalpa', continent: 'North America', subregion: 'Central America', population: 10.4, areaSqKm: 112492, famousCities: ['Tegucigalpa', 'San Pedro Sula'], landmark: 'Copán Mayan Ruins' },
  ...
  { id: 'bol', iso2: 'bo', name: 'Bolivia', flag: '🇧🇴', capital: 'Sucre', altNames: ['La Paz'], continent: 'South America', subregion: 'South America', population: 12.2, areaSqKm: 1098581, famousCities: ['La Paz', 'Sucre', 'Santa Cruz'], landmark: 'Salar de Uyuni Salt Flats' },
  { id: 'pry', iso2: 'py', name: 'Paraguay', flag: '🇵🇾', capital: 'Asunción', continent: 'South America', subregion: 'South America', population: 6.8, areaSqKm: 406752, famousCities: ['Asunción', 'Ciudad del Este'], landmark: 'Itaipu Dam' },
  ...
  { id: 'nam', iso2: 'na', name: 'Namibia', flag: '🇳🇦', capital: 'Windhoek', continent: 'Africa', subregion: 'Southern Africa', population: 2.6, areaSqKm: 825615, famousCities: ['Windhoek', 'Swakopmund'], landmark: 'Deadvlei Sand Dunes' },
  { id: 'bwa', iso2: 'bw', name: 'Botswana', flag: '🇧🇼', capital: 'Gaborone', continent: 'Africa', subregion: 'Southern Africa', population: 2.6, areaSqKm: 581730, famousCities: ['Gaborone', 'Maun'], landmark: 'Okavango Delta' },
  ...
  { id: 'ago', iso2: 'ao', name: 'Angola', flag: '🇦🇴', capital: 'Luanda', continent: 'Africa', subregion: 'Central Africa', population: 35.6, areaSqKm: 1246700, famousCities: ['Luanda', 'Lubango'], landmark: 'Kalandula Falls' },
  { id: 'moz', iso2: 'mz', name: 'Mozambique', flag: '🇲🇿', capital: 'Maputo', continent: 'Africa', subregion: 'Southern Africa', population: 33.0, areaSqKm: 801590, famousCities: ['Maputo', 'Beira'], landmark: 'Bazaruto Archipelago' },
  ...
  { id: 'cpv', iso2: 'cv', name: 'Cape Verde', flag: '🇨🇻', capital: 'Praia', continent: 'Africa', subregion: 'Western Africa', population: 0.59, areaSqKm: 4033, famousCities: ['Praia', 'Mindelo'], landmark: 'Pico do Fogo Volcano', mountain: 'Pico do Fogo' },
  ...
  { id: 'cog', iso2: 'cg', name: 'Republic of the Congo', flag: '🇨🇬', capital: 'Brazzaville', continent: 'Africa', subregion: 'Central Africa', population: 5.9, areaSqKm: 342000, famousCities: ['Brazzaville', 'Pointe-Noire'], landmark: 'Odzala-Kokoua National Park' },
  { id: 'cod', iso2: 'cd', name: 'DR Congo', altNames: ['Congo', 'Democratic Republic of the Congo'], flag: '🇨🇩', capital: 'Kinshasa', continent: 'Africa', subregion: 'Central Africa', population: 99.0, areaSqKm: 2344858, famousCities: ['Kinshasa', 'Lubumbashi'], landmark: 'Virunga National Park', river: 'Congo River' },
